...
public class BoidUI : MonoBehaviour
{
    ...
    public void OnChangeValue()
    {
        ...
        {
            child.transform.GetChild(0).GetComponent<Boid_handle>().alpha = (float)CohesionHanlder.value;
            child.transform.GetChild(0).GetComponent<Boid_handle>().beta = (float)SeparationeHanlder.value;
            child.transform.GetChild(0).GetComponent<Boid_handle>().gamma = (float)AlignementHanlder.value;
        }
    }
}
